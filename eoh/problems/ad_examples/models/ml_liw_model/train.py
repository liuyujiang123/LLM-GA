...
from models import Inceptionv3Rank
from voc import *
...
def main_open_images():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if is_best:
            best_loss = val_loss
        save_checkpoint(model, is_best, best_loss,
                        save_model_path='/home/lyj/LLMs_Multi_Labels/eoh/problems/ad_examples/checkpoint/mlliw/open_images',
                        filename='open_images_checkpoint.pth.tar')
