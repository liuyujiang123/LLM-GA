...
class InterfaceEC():
    ...
    def get_offspring(self, pop, operator, device_id):
    ...
    def get_algorithm(self, pop, operator):
        ...
        results = []
        try:
            results = Parallel(n_jobs=self.n_p,timeout=self.timeout+15)(delayed(self.get_offspring)(pop, operator, i) for i in range(self.pop_size))
        except:
