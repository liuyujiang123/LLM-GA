    ...
    def run(self):
        ...
        if self.use_seed:
            ...
            if self.load_pop:  # load population from files
                ...
                population = interface_ec.population_generation(self.worst)
                population, self.worst= self.manage.population_management(population, self.pop_size)
        ...
        for pop in range(n_start, self.n_pop):  
            ...
            for i in range(n_op):
                ...
                if (np.random.rand() < op_w):
                    parents, offsprings = interface_ec.get_algorithm(population, op, self.worst)
                ...
                population, self.worst = self.manage.population_management(population, size_act)
                print()
            ...
            print()
        print(f"代码生成成功率{gv.succ_val / gv.total_val}")
        with open('log.txt', 'a') as f:
            f.write(f"Total evaluations: {gv.total_val}, Successful evaluations: {gv.succ_val}\n")
